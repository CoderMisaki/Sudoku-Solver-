...
## 2026-06-05 - Add Content Security Policy
**Vulnerability:** Missing CSP increases XSS risks.
**Learning:** Implementing a strict CSP mitigates XSS and limits external script execution to trusted domains like Tailwind CDN.
**Prevention:** Always enforce a Content-Security-Policy on static web applications.
