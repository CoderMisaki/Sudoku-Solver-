...
## 2024-05-24 - Pinning CDN Versions for SRI
**Vulnerability:** Unpinned CDN URL used for TailwindCSS without integrity hashes, exposing the app to supply chain attacks.
**Learning:** Dynamic CDNs break SRI hashes upon updates. To use SRI, the CDN URL must be pinned to a specific version.
**Prevention:** Always pin 3rd party scripts to strict versions and compute/apply `integrity` attributes.
